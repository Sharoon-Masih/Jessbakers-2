...
const Hero = async () => {
  ...
  return (
    <section className={`h-screen relative overflow-x-hidden ${poppin.className} lg:overflow-hidden`}>
      <div className='2xl:max-w-[1280px] mx-auto flex h-full items-start justify-between m-auto px-4 pt-[76px] lg:px-0 lg:pt-[96px] lg:pl-[93px] '>
        <div className=' z-10 flex flex-col justify-between text-[#4A1D1F] items-center lg:items-start'>
        <h1 className={`md:text-center  lg:text-start lg:w-[530px] lg:h-[132] text-[44px] font-bold`}>{Data[0].mainText}</h1>
        <p className=' md:text-center lg:text-start pt-[20px] lg:w-[510px] lg:h-[108px] text-[24px] font-normal text-[#272727] '>{Data[0].desc}</p>
        </div>
