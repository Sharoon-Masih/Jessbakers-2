...
const About = () => {
    return (
        <section className={`${poppin.className} text-[#4A1D1F]`} id='about'>
            <div className='2xl:max-w-[1280px] mx-auto flex flex-col lg:flex-row justify-between min-h-[347px] items-center   text-[#4A1D1F] pt-[66px] lg:pt-[96px] relative px-4 md:gap-4  lg:gap-0'>
            ...
            <div className='2xl:max-w-[1280px] mx-auto flex flex-col-reverse lg:flex-row justify-between min-h-[347px] items-center   text-[#4A1D1F] py-[66px] lg:py-[96px] relative px-4 md:gap-4  lg:gap-0'>
